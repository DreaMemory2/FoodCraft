...
public class ChoppingBoardScreen extends AbstractContainerScreen<@NotNull ChoppingBoardMenu> {
    public static final Identifier TEXTURE = FoodCraft.of("textures/gui/container/chopping_board.png");

    public ChoppingBoardScreen(@NotNull ChoppingBoardMenu menu, Inventory inventory, Component title) {
